      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 items-center justify-center max-w-xl mx-auto">
            ...
            <button className="px-6 py-3 bg-gray-300/30 border border-gray-300/50 text-gray-700 rounded-full hover:bg-gray-100/50 transition-colors whitespace-nowrap">
